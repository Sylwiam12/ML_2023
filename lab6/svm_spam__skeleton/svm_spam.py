...
file_contents = read_file("./lab6/svm_spam__skeleton/data/emailSample1.txt")
...
X_train = np.genfromtxt("./lab6/svm_spam__skeleton/data/spamTrain_X.csv", delimiter=',')
y_train = np.genfromtxt("./lab6/svm_spam__skeleton/data/spamTrain_y.csv", delimiter=',')
...
X_test = np.genfromtxt("./lab6/svm_spam__skeleton/data/spamTest_X.csv", delimiter=',')
y_test = np.genfromtxt("./lab6/svm_spam__skeleton/data/spamTest_y.csv", delimiter=',')
...
filename = "./lab6/svm_spam__skeleton/data/spamSample1.txt"
